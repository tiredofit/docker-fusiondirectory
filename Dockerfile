...
ARG ARGONAUT_VERSION
ARG FUSIONDIRECTORY_VERSION
ARG FUSIONDIRECTORY_PLUGINS_VERSION

## Set Environment Varialbes
ENV ARGONAUT_VERSION=${ARGONAUT_VERSION:-"1.4-dev"} \
    FUSIONDIRECTORY_VERSION=${FUSIONDIRECTORY_VERSION:-"b246399ff2d3dc74565c9f3897e4a3544e0c51d1"} \
    FUSIONDIRECTORY_REPO_URL=https://github.com/fusiondirectory/fusiondirectory \
    FUSIONDIRECTORY_PLUGINS_VERSION=${FUSIONDIRECTORY_PLUGINS_VERSION:-"b0078c722634cbd42fe2b0231eb8d40c6d87df3e"} \
